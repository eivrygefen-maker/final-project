# M4.5.1 batch dry-run — sample_002

- batch_id: `m4_5_first3_lhs`
- run_id: `sample_002_m45dry1`
- reuse_status: **planned_new_run**
- will_execute: **false**

## Stages (planned)

- **Stage 0 — sample/config**: PLANNED — `# resolve overlay for sample_002 (v2_b3_resolve_pilot_core_config.py pattern)`
