#!/usr/bin/env python3
"""Stage 5.1 STK V4.1 strict hybrid diagnostics builder."""
...
from stage51_rom_readiness_report import build_rom_readiness_report  # noqa: E402
from stage51_stk_v4_1_report import build_stage51_v4_1_report  # noqa: E402
from synthesis_presets import DEFAULT_SYNTHESIS_PRESET  # noqa: E402

DEFAULT_OUT = REPO / "audio" / "stk_v4_1_hybrid_core_diagnostics"
DEFAULT_MODES = (
    "baseline_current,modal_radiation_color_v1,modal_body_signature_v3_full,"
    "modal_body_hybrid_v4_full,modal_body_hybrid_v4_1_core,modal_body_hybrid_v4_1_full"
)


def build_v4_1_diagnostics(
    *,
    repo_root: Path,
    out_dir: Path,
    ...
    build_stage51_v4_1_report(
        mode_summaries=mode_summaries,
        endpoint_rows=endpoint_rows,
        notes=[n for n, _ in notes],
        modes=modes,
        build_manifest=manifest,
        out_json=report_dir / "stage51_stk_v4_1_report.json",
        out_md=report_dir / "stage51_stk_v4_1_report.md",
    )
    build_rom_readiness_report(
        repo_root,
        out_json=report_dir / "stage51_rom_readiness_report.json",
        out_md=report_dir / "stage51_rom_readiness_report.md",
    )
    return manifest


def main(argv: Optional[Sequence[str]] = None) -> int:
    parser = argparse.ArgumentParser(description="Stage 5.1 STK V4.1 diagnostics + ROM readiness")
