...
DIAGNOSTIC_MODES: Dict[str, DiagnosticSynthesisConfig] = {
    ...
    "modal_body_hybrid_v4_1_identity_contrast_hybrid": DiagnosticSynthesisConfig(
        name="modal_body_hybrid_v4_1_identity_contrast_hybrid",
        raw_body_variation_preserve=0.50,
        body_gain_normalization_strength=0.36,
        final_loudness_normalization_strength=0.34,
        description="Stage 5.1F hybrid identity+contrast (40/60 default).",
    ),
    "stk_body_transfer_v4_1_identity_contrast_hybrid": DiagnosticSynthesisConfig(
        name="stk_body_transfer_v4_1_identity_contrast_hybrid",
        raw_body_variation_preserve=0.50,
        body_gain_normalization_strength=0.36,
        final_loudness_normalization_strength=0.34,
        description="Stage 5.1F hybrid identity+contrast alias.",
    ),
    "modal_body_hybrid_v4_1_identity_contrast_hybrid_25_75": DiagnosticSynthesisConfig(
        name="modal_body_hybrid_v4_1_identity_contrast_hybrid_25_75",
        raw_body_variation_preserve=0.50,
        body_gain_normalization_strength=0.36,
        final_loudness_normalization_strength=0.34,
        description="Stage 5.1F hybrid 25% absolute / 75% contrast.",
    ),
    "modal_body_hybrid_v4_1_identity_contrast_hybrid_40_60": DiagnosticSynthesisConfig(
        name="modal_body_hybrid_v4_1_identity_contrast_hybrid_40_60",
        raw_body_variation_preserve=0.50,
        body_gain_normalization_strength=0.36,
        final_loudness_normalization_strength=0.34,
        description="Stage 5.1F hybrid 40% absolute / 60% contrast.",
    ),
    "modal_body_hybrid_v4_1_identity_contrast_hybrid_50_50": DiagnosticSynthesisConfig(
        name="modal_body_hybrid_v4_1_identity_contrast_hybrid_50_50",
        raw_body_variation_preserve=0.50,
        body_gain_normalization_strength=0.36,
        final_loudness_normalization_strength=0.34,
        description="Stage 5.1F hybrid 50% absolute / 50% contrast.",
    ),
    "modal_body_hybrid_v4_1_identity_contrast_g_20_80": DiagnosticSynthesisConfig(
        name="modal_body_hybrid_v4_1_identity_contrast_g_20_80",
        raw_body_variation_preserve=0.52,
        body_gain_normalization_strength=0.34,
        final_loudness_normalization_strength=0.32,
        description="Stage 5.1G 20% absolute / 80% contrast physical differentiation.",
    ),
    "modal_body_hybrid_v4_1_identity_contrast_g_25_75": DiagnosticSynthesisConfig(
        name="modal_body_hybrid_v4_1_identity_contrast_g_25_75",
        raw_body_variation_preserve=0.52,
        body_gain_normalization_strength=0.34,
        final_loudness_normalization_strength=0.32,
        description="Stage 5.1G 25% absolute / 75% contrast physical differentiation.",
    ),
    "modal_body_hybrid_v4_1_identity_contrast_g_30_70": DiagnosticSynthesisConfig(
        name="modal_body_hybrid_v4_1_identity_contrast_g_30_70",
        raw_body_variation_preserve=0.52,
        body_gain_normalization_strength=0.34,
        final_loudness_normalization_strength=0.32,
        description="Stage 5.1G 30% absolute / 70% contrast physical differentiation.",
    ),
    "modal_body_hybrid_v4_1_identity_contrast_g_25_75_decay": DiagnosticSynthesisConfig(
        name="modal_body_hybrid_v4_1_identity_contrast_g_25_75_decay",
        raw_body_variation_preserve=0.52,
        body_gain_normalization_strength=0.34,
        final_loudness_normalization_strength=0.32,
        description="Stage 5.1G 25/75 + physical decay envelope on body residual.",
    ),
    "modal_body_hybrid_v4_1_identity_contrast_g_25_75_bridge": DiagnosticSynthesisConfig(
        name="modal_body_hybrid_v4_1_identity_contrast_g_25_75_bridge",
        raw_body_variation_preserve=0.52,
        body_gain_normalization_strength=0.34,
        final_loudness_normalization_strength=0.32,
        description="Stage 5.1G 25/75 + bridge/body energy-transfer coupling.",
    ),
    "modal_body_hybrid_v4_1_identity_contrast_g_25_75_full": DiagnosticSynthesisConfig(
        name="modal_body_hybrid_v4_1_identity_contrast_g_25_75_full",
        raw_body_variation_preserve=0.52,
        body_gain_normalization_strength=0.34,
        final_loudness_normalization_strength=0.32,
        description="Stage 5.1G 25/75 + decay + bridge physical differentiation (main candidate).",
    ),
    "stk_body_transfer_v4_1_identity_contrast_g": DiagnosticSynthesisConfig(
        name="stk_body_transfer_v4_1_identity_contrast_g",
        raw_body_variation_preserve=0.52,
        body_gain_normalization_strength=0.34,
        final_loudness_normalization_strength=0.32,
    ...
    # STK V6.2.1 — balance repair variants (diagnostic only)
    "stk_v6_2_1_balanced_tail_alpha": DiagnosticSynthesisConfig(
        name="stk_v6_2_1_balanced_tail_alpha",
        raw_body_variation_preserve=0.70,
        body_gain_normalization_strength=0.0,
        final_loudness_normalization_strength=0.10,
        description="STK V6.2.1 balanced tail alpha — softer pluck, sustain-window norm (diagnostic only).",
    ),
    "stk_v6_2_1_soft_pluck_tail_alpha": DiagnosticSynthesisConfig(
        name="stk_v6_2_1_soft_pluck_tail_alpha",
        raw_body_variation_preserve=0.70,
        body_gain_normalization_strength=0.0,
        final_loudness_normalization_strength=0.10,
